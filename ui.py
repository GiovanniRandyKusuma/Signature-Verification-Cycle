...
def main():
    ...
    # st.session_state = SessionState.get(
    #     selection = '',
    #     yolo_op = '',
    #     detect_button = False,
    #     clean_button = False,
    ...
    detect_form = st.form("detect_form")
    clean_form = st.form("clean_form")
    detect_button = detect_form.form_submit_button('Detect Signature')
    if (detect_button):
        ...
        # clean_button = clean_form.form_submit_button('Clean Signature')
        # if clean_button:
